...
/**
 * Servlet implementation class AnswerMCQSServlet
 */
@WebServlet("/AnswerMCQSServlet")
public class AnswerMCQSServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AnswerMCQSServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	int mcqid = Integer.parseInt((request.getParameter("mcqaids")));
		String mcqanswer = request.getParameter("mcqans");
		int attempt = 0;
